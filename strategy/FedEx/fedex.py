"""
Description: This file consists the sever side aggregation operations for FedEx (PaLA) algorithm.

## Naming Note
FEDEX is the internal code alias for PaLA: Partial Layer Aggregation with shared extractors and local classifiers.
